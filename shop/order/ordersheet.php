        ...
        <main id="order">
            <div class="wrapper">
                ...
                <form id="frm" method="post" action="/php/order.php" enctype="multipart/form-data">
                    ...
                    <section class="order_section half_section">
                        <div class="half">
                        ...
                        <div class="half">
                            ...
                            <ul class="form_wrap with_title">
                                ...
                                <li>
                                    <div class="form_label_ani">
                                        <div class="form_title">배송메세지</div>
                                        <fieldset>
                            ...
                            <ul class="payment_type">
                                <li>
                                    ...
                                    <label for="orderPayType1">
                                        <img src="<?= artFoldName ?>/img/mypage/payment_icon1.png" alt="신용카드/간편결제">
                                        <span>신용카드/간편결제</span>
                                    </label>
                                </li>
                            ...
                            <div class="payment_cont">
                                ...
                                <div class="payment_info payment_info3">
                                    <ul class="form_wrap with_title">
                                        <li>
                                            <div class="form_label_ani">
                                                <div class="form_title">입금은행 선택 *</div>
                                                <fieldset>
                                        ...
                                        <li>
                                            <div class="form_label_ani">
                                                <div class="form_title">입금자 명 *</div>
                                                <fieldset>
