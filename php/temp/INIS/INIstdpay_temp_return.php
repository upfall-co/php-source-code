            ...
            if (strcmp("0000", $_REQUEST["resultCode"]) == 0) {
                ...
                if (strcmp($authUrl, $_REQUEST["authUrl"]) == 0) {
                    ...
                    try {
                        ...
                        $resultMap_code = $resultMap["resultCode"];
                        $resultMap_msg = $resultMap["resultMsg"];
                        ...
                        if (strcmp("0000", $resultMap["resultCode"]) == 0) {
                            ...
                            if (!$clefResult->getResult()) {
                                dieAndErrorMove('잘못된 접근입니다. 503');
                            }
                            
                            $mysqldb->link->commit();

                            include_once $_SERVER['DOCUMENT_ROOT'] . '/php/temp/INIS/INIstdpay_temp_custom.php';
                        }
                    } catch (Exception $e) {
...
<?php include_once $_SERVER['DOCUMENT_ROOT'] . '/php/temp/INIS/INIstdpay_temp_custom.php'; ?>
