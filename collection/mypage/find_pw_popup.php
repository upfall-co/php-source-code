    ...
    <ul class="form_wrap">
        <li>
            <div class="form_label_ani">
                <input id="find_pw_member_id" name="member_id" type="text" placeholder="회원 아이디">
                <label title="Name">회원 아이디</label>
                <div class="erase_btn" onclick="eraseThisForm(this);"><img src="<?= artFoldName ?>/img/erase_icon.png" alt="내용 지우기"></div>
            </div>
        </li>
        <!--<li>
            <div class="form_label_ani">
                <input id="find_pw_member_name" name="member_name" type="text" placeholder="이름">
