 ...
 */
    ...
    //php setting
    include_once $_SERVER['DOCUMENT_ROOT'].'/php/contact_main_code.php';
?>
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="TITLE" name="TITLE" value="<?=$TITLE;?>" placeholder="제목을 입력해주세요." class="form-control">
                                        </div>
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title p-md">
                            ...
                            <div class="ibox-tools">
                                <button type="button" class="btn btn-primary btn-s m-t-xs" onclick="javascript:location.href='contact_details.php?<?=$INS_query_string?>&mode=INS';">등록</button>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 170px;">제목</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 170px;">영문</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 20px;">노출여부</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending" style="width: 10px;">정렬</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 30px;">등록일</th>
                                            </tr>
                                        </thead>
