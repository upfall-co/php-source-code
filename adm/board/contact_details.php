 ...
 */
    ...
    //php setting
    include_once $_SERVER['DOCUMENT_ROOT'].'/php/contact_details_code.php';
?>
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-content custom_detail">
                            <form id="frm" method="post" action="/php/contact.php" enctype="multipart/form-data">
                                <input type="hidden" id="m_seq" name="m_seq" value="<?=$m_seq?>"/>
                                <input type="hidden" id="mp_seq" name="mp_seq" value="<?=$mp_seq?>"/>
                                <input type="hidden" id="mode" name="mode" value="<?=$mode?>"/> 
                                <input type="hidden" id="SEQ" name="SEQ" value="<?=$CONTACT_SEQ?>"/>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 b-r">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="TITLE" name="TITLE" value="<?=$_db_TITLE?>" placeholder="제목을 입력해주세요." max-length="150">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="LINK_URL" name="LINK_URL" value="<?=$_db_LINK_URL?>" placeholder="링크를 입력해주세요." max-length="255">
                                            </div>
                                        </div>

                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group row">
                                            <label class="col-sm-1 text-right col-form-label">제목 - EN</label>

                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="TITLE_EN" name="TITLE_EN" value="<?=$_db_TITLE_EN?>" placeholder="제목(영문)을 입력해주세요." max-length="150">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="EMAIL" name="EMAIL" value="<?=$_db_EMAIL?>" placeholder="이메일을 입력해주세요." max-length="100">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="MOBILE" name="MOBILE" value="<?=$_db_MOBILE?>" placeholder="연락처를 입력해주세요." max-length="100">
                                            </div>
                                        </div>

                                        <div class="hr-line-dashed"></div>
                                        <div class="form-group row">
                                            <label class="col-sm-1 text-right col-form-label">시간</label>

                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="DATE_VALUE" name="DATE_VALUE" value="<?=$_db_DATE_VALUE?>" placeholder="시간정보를 입력해주세요." max-length="100">
                                            </div>
                                        </div>
                                        ...
                                        <div class="dv_Button" id="dv_Button" name="dv_Button">
                                            ...
                                            <?php }?>
                                            <button type="button" class="btn btn-lg btn-outline btn-secondary float-right w60" onclick="javascript:location.href='contact_main.php?<?=$query_string;?>';">취소</button>
                                        </div>
