 ...
 */
    ...
    //php setting
    include_once $_SERVER['DOCUMENT_ROOT'].'/php/memberManagement_main_code.php';
?>
                    ...
                    <div class="ibox ">
                        ...
                        <div class="ibox-content m-b-sm border-bottom custom_search_top">
                            <form id="frm" method="get" action="<?=$_SERVER['PHP_SELF'];?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            <label class="col-form-label ml-2" for="order_id">회원구분</label>

                                            <select class="form-control" id="TYPE_CD" name="TYPE_CD" >
                                                <?php gfn_getComboList("회원구분","AD013",$TYPE_CD,"구분")?>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3">
                                        <label class="col-form-label ml-2" for="order_id">가입일</label>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: auto;">회원구분</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 150px;">SNS 가입여부</th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 150px;">SNS 가입경로 <br>(카카오, 네이버)</th>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('.dataTables-example').DataTable({
            ...
            language: {
                emptyTable: "가입된 회원이 없습니다." // "No data available in table" 대신 사용할 메시지 설정
            },
