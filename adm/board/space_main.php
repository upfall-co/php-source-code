 ...
 */
    ...
    //php setting
    include_once $_SERVER['DOCUMENT_ROOT'].'/php/space_main_code.php';
?>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                <label class="col-form-label ml-2" for="order_id">층수</label>

                                                <select class="form-control" id="TYPE_CD" name="TYPE_CD" >
                                                    <?php gfn_getComboList("층수구분","COL011", $TYPE_CD, "층수")?>
                                                </select>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox ">
                            <div class="ibox-title p-md">
                                ...
                                <div class="ibox-tools">
                                    <button type="button" class="btn btn-primary btn-s m-t-xs" onclick="javascript:location.href='space_details.php?<?=$INS_query_string?>&mode=INS';">등록</button>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">층수</th>
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">제목</th>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 60px;">등록일</th>
                                                </tr>
                                            </thead>
...
<script>
    ...
    $(document).ready(function(){
        $('.dataTables-example').DataTable({
            ...
            language: {
                emptyTable: "등록된 <?=$title_name?>이 없습니다." // "No data available in table" 대신 사용할 메시지 설정
            },
