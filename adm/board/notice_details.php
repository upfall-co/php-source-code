 ...
 */
    ...
    //php setting
    include_once $_SERVER['DOCUMENT_ROOT'].'/php/notice_details_code.php';
?>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 b-r">
                                        ...
                                        <div class="dv_Button" id="dv_Button" name="dv_Button">
                                            ...
                                            <?php }?>
                                            <button type="button" class="btn btn-lg btn-outline btn-secondary float-right w60" onclick="javascript:location.href='notice_main.php?<?=$query_string;?>';">취소</button>
                                        </div>
