 ...
 */
    ...
    //php setting
    include_once $_SERVER['DOCUMENT_ROOT'].'/php/writer_main_code.php';
?>
                                ...
                                <div class="row">
                                    <div class="col-sm-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="TITLE" name="TITLE" value="<?=$TITLE;?>" placeholder="<?=$title_val?>을 입력해주세요." class="form-control">
                                        </div>
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        <div class="ibox-title p-md">
                            ...
                            <div class="ibox-tools">
                                <button type="button" class="btn btn-primary btn-s m-t-xs" onclick="javascript:location.href='writer_details.php?<?=$INS_query_string?>&mode=INS';">등록</button>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info" role="grid">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;"><?=$title_val?></th>
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 20px;">노출여부</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending" style="width: 20px;">등록자</th>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1"><?=$title_val?></th>
...
<script>
    ...
    $(document).ready(function(){
        $('.dataTables-example').DataTable({
            ...
            language: {
                emptyTable: "등록된 <?=$title_name?>가 없습니다." // "No data available in table" 대신 사용할 메시지 설정
            },
